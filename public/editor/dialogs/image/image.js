    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            uploader = _this.uploader = WebUploader.create({
                ...
                server: actionUrl,
                method:'POST',
                formData:editor.getOpt('upyunSignature'),
                sendAsBinary: false,
            ...
            /*uploader.on('uploadBeforeSend', function (file, data, header) {
                ...
                let upyunSignature=editor.getOpt('upyunSignature')
                //header['X_Requested_With'] = 'XMLHttpRequest';
                data.policy=upyunSignature.policy
                data.signature=upyunSignature.signature
                // HaoChuan9421
